...
const LANGUAGES = [
    ...
    { code: "cu", name: "Old Church Slavonic / Old Bulgarian", native: "словѣньскъ / slověnĭskŭ" },
    ...
    { code: "sh", name: "Serbo-Croatian", native: "Srpskohrvatski / Српскохрватски" },
...
export { KIND_LIST, QUANTITY, LANGUAGES }
